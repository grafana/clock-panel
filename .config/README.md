...
Edit the `eslint.config.mjs` file in the project root in order to extend the ESLint configuration. The following example disables deprecation notices for source files.
