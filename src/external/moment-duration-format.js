...
(function (root, factory) {
  ...
  function featureTestToLocaleString() {
    ...
    passed =
      passed && (99.99).toLocaleString('en', { maximumFractionDigits: 3, minimumFractionDigits: 3 }) === '99.990';
    if (!passed) {
      return false;
    }
  ...
  function durationFormat() {
    ...
    tokens = map(tokens, function (token) {
      ...
      if (
        isNegative &&
        (momentType.value > 0 || find(stopTrim, momentType.type) || find(outputTypes, momentType.type))
      ) {
        out += '-';
        isNegative = false;
      }
